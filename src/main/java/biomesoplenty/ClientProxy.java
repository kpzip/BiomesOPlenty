...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers() {
        ...
        if (BOPConfigurationIDs.globID > 0) {
            RenderingRegistry.registerEntityRenderingHandler(
                EntityGlob.class,
                new RenderGlob(new ModelSlime(16), new ModelSlime(0), 0.25F));
        }
        ...
        if (BOPConfigurationIDs.rosesterID > 0) {
            RenderingRegistry
                .registerEntityRenderingHandler(EntityRosester.class, new RenderRosester(new ModelChicken(), 0.3F));
        }
    ...
    public void spawnParticle(String string, double x, double y, double z, Object... args) {
        ...
        if (string == "mud") {
            ...
            entityfx = new EntityMagicTreeFX(
                minecraft.theWorld,
                x,
                y,
                z,
                MathHelper.getRandomDoubleInRange(rand, -0.03, 0.03),
                -0.02D,
                MathHelper.getRandomDoubleInRange(rand, -0.03, 0.03));
        } else if (string == "pixietrail") {
            entityfx = new EntityPixieTrailFX(
                minecraft.theWorld,
                x,
                y,
                z,
