    ...
    protected ExternalTexture(File imageFile, String imageUrl, IVersionChecker versionChecker) {
        ...
        if (!imageFile.exists() || versionChecker != null ? !versionChecker.isUpToDate(getBaseName()) : false) {
            ...
            try {
                ...
                BOPLogger.log(
                    Level.ERROR,
                    "Could not read existing image from: " + imageFile.getAbsolutePath() + ". Attempting redownload.",
                    exception);
        ...
        this.imageThread = new Thread("Texture Downloader #" + threadDownloadCounter.incrementAndGet()) {
            ...
            public void run() {
                ...
                BOPLogger.log(
                    ...
                    new Object[] { ExternalTexture.this.imageUrl, ExternalTexture.this.imageFile });

                try {
                    httpurlconnection = (HttpURLConnection) (new URL(ExternalTexture.this.imageUrl)).openConnection(
                    ...
                    if (httpurlconnection.getResponseCode() / 100 == 2) {
                        ...
                        if (ExternalTexture.this.imageFile != null) {
                            FileUtils.copyInputStreamToFile(
                                ...
                                ExternalTexture.this.imageFile);
