 ...
 * {
 * private static ResourceLocation biomeBookTexture = new
 * ResourceLocation("biomesoplenty:textures/gui/screen/biomebookgui.png");
 ...
 * this.pageLinks.add(new PageLink(3, i + 41 + (fontRendererObj.getStringWidth("Contents") / 2) + 7, b0 + 154, 0x6189CE,
 * "Contents", 1, 2, 0));
 * addLinks();
 ...
 * int bookTotalPages = BOPReflectionHelper.getPrivateValue(GuiScreenBook.class, this, "bookTotalPages",
 * "bookTotalPages");
 ...
 * byte b0 = 2;
 * //TODO: fontRendererObj
 * this.pageLinks.add(new PageLink(3 + pageLinks.size(), i + 34 +
 * fontRendererObj.getStringWidth(lineText.split(originalLinkString)[0]), b0 + 31 + (line * 9), 0x6189CE, linkText,
 * pageNo, 0, linkedPage));
 ...
 * boolean isHovering = mouseX >= this.xPosition && mouseY >= this.yPosition && mouseX < this.xPosition + this.width &&
 ...
 * public PageLink(int id, int xPosition, int yPosition, int colour, String text, int displayPage, int displayType, int
 * pageNumber)
 * {
 * //TODO: fontRendererObj
