...
public class StartupWarningGUI extends GuiScreen {
    ...
    private static final ResourceLocation bopLogoTexture = new ResourceLocation(
        "biomesoplenty:textures/gui/logo256.png");
    ...
    public void drawScreen(int x, int y, float renderPartialTicks) {
        ...
        this.drawCenteredString(
            ...
            "" + RED + StatCollector.translateToLocal("warning.bopStartup1"),
            this.width / 2,
            82,
            0xFFFFFF);
        this.drawCenteredString(
            this.fontRendererObj,
            "" + RED + StatCollector.translateToLocal("warning.bopStartup2"),
            this.width / 2,
            94,
            0xFFFFFF);
        this.drawCenteredString(
            this.fontRendererObj,
            "" + RED + StatCollector.translateToLocal("warning.bopStartup3"),
            this.width / 2,
            106,
            0xFFFFFF);
        ...
        this.drawCenteredString(
            this.fontRendererObj,
            "" + RED + StatCollector.translateToLocal("warning.bopStartup4"),
            this.width / 2,
            132,
            0xFFFFFF);
        this.drawCenteredString(
            this.fontRendererObj,
            "" + RED + StatCollector.translateToLocal("warning.bopStartup5"),
            this.width / 2,
            144,
            0xFFFFFF);
        ...
        this.drawCenteredString(
            this.fontRendererObj,
            "" + DARK_RED + StatCollector.translateToLocal("warning.bopStartup6"),
            this.width / 2,
            168,
            0xFFFFFF);
    ...
    public void drawCenteredString(FontRenderer fontRenderer, String string, int x, int y, int colour) {
        fontRenderer.drawStringWithShadow(
            string,
            x - fontRenderer.getStringWidth(string.replaceAll("\\P{InBasic_Latin}", "")) / 2,
            y,
            colour);
    }
}
