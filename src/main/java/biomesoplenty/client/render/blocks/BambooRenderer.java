...
public class BambooRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (renderer.renderAllFaces || block.shouldSideBeRendered(world, x, y - 1, z, 0)) {
            ...
            tessellator
                .setBrightness(renderer.renderMinY > 0.0D ? m : block.getMixedBrightnessForBlock(world, x, y - 1, z));
        ...
        if (renderer.renderAllFaces || block.shouldSideBeRendered(world, x, y + 1, z, 1)) {
            ...
            tessellator
                .setBrightness(renderer.renderMaxY < 1.0D ? m : block.getMixedBrightnessForBlock(world, x, y + 1, z));
        ...
        renderer.renderFaceZNeg(
            ...
            (double) y,
            (double) z + (pixel * 4),
            renderer.getBlockIcon(block, world, x, y, z, 2));
        tessellator.addTranslation(0.0F, 0.0F, -pixel);
        tessellator.addTranslation(0.0F, 0.0F, -pixel);
        ...
        renderer.renderFaceZPos(
            ...
            (double) y,
            (double) z - (pixel * 4),
            renderer.getBlockIcon(block, world, x, y, z, 3));
        tessellator.addTranslation(0.0F, 0.0F, pixel);
        ...
        renderer.renderFaceXNeg(
            ...
            (double) y,
            (double) z,
            renderer.getBlockIcon(block, world, x, y, z, 4));
        tessellator.addTranslation(-pixel, 0.0F, 0.0F);
        tessellator.addTranslation(-pixel, 0.0F, 0.0F);
        ...
        renderer.renderFaceXPos(
            ...
            (double) y,
            (double) z,
            renderer.getBlockIcon(block, world, x, y, z, 5));
        tessellator.addTranslation(pixel, 0.0F, 0.0F);
