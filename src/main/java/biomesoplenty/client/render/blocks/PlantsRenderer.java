...
public class PlantsRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (modelId == RenderUtils.plantsModel) {
            ...
            if (meta < 5) return renderCrossedSquares(block, x, y, z, renderer, true);
            if (meta == 5)
                // TODO: renderCrossedSquares
                return renderer.renderCrossedSquares(block, x, y, z);
            if (meta == 6) return renderBlockCrops(block, x, y, z, renderer);
            if (meta == 7)
            ...
            if (meta == 11)
                // TODO: renderBlockCrops
                return renderer.renderBlockCrops(block, x, y, z);
            if (meta == 12) return renderCrossedSquares(block, x, y, z, renderer, true);
            if (meta == 13)
                // TODO: renderBlockCrops
                return renderer.renderBlockCrops(block, x, y, z);
            if (meta == 14) {
            ...
            if (meta == 15) return renderCrossedSquares(block, x, y, z, renderer, true);
        }
        return true;
    }
    ...
    private boolean renderCrossedSquares(Block block, int x, int y, int z, RenderBlocks renderer,
        boolean colourMultiply) {
        Tessellator tessellator = Tessellator.instance;
        // TODO: blockAccess
        IBlockAccess world = renderer.blockAccess;
        // TODO: getMixedBrightnessForBlock()
