...
public abstract class GenLayerBOP extends GenLayer {
    ...
    public static GenLayer[] initializeAllBiomeGenerators(long seed, WorldType par2WorldType) {
        boolean flag = false;
        GenLayer genLayerCreateLand = BOPConfigurationTerrainGen.oceanFiller ? new GenLayerIsland(1L)
            : new GenLayerCreateLand(1L);
        ...
        GenLayerAddSnow genlayeraddsnow = new GenLayerAddSnow(
            2L,
            BOPConfigurationTerrainGen.oceanFiller ? genlayerremovetoomuchocean : genlayeraddisland);
