...
public class GenLayerShoreBOP extends GenLayer {
            ...
            for (int j1 = 0; j1 < width; ++j1) {
                ...
                if (landBiomeId == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    if (l1 != BiomeGenBase.ocean.biomeID && i2 != BiomeGenBase.ocean.biomeID
                        && j2 != BiomeGenBase.ocean.biomeID
                        && k2 != BiomeGenBase.ocean.biomeID) {
                    ...
                    if (this.func_151631_c(l1) && this.func_151631_c(i2)
                        && this.func_151631_c(j2)
                        && this.func_151631_c(k2)) {
                ...
                } else if (landBiomeId != BiomeGenBase.extremeHills.biomeID
                    && landBiomeId != BiomeGenBase.extremeHillsPlus.biomeID
                    && landBiomeId != BiomeGenBase.extremeHillsEdge.biomeID) {
                        if (biomegenbase != null && biomegenbase.func_150559_j()) {
                            this.func_151632_a(
                                ...
                                width,
                                landBiomeId,
                                BiomeGenBase.coldBeach.biomeID);
                        } else if (landBiomeId != BiomeGenBase.mesa.biomeID
                            && landBiomeId != BiomeGenBase.mesaPlateau_F.biomeID) {
                                if (!BOPBiomeManager.isBiomeOceanic(landBiomeId)
                                    && landBiomeId != BiomeGenBase.ocean.biomeID
                                    && landBiomeId != BiomeGenBase.deepOcean.biomeID
                                    && landBiomeId != BiomeGenBase.river.biomeID
                                    && landBiomeId != BiomeGenBase.swampland.biomeID) {
                                    l1 = inputBiomeIds[j1 + 1 + (i1 + 1 - 1) * (width + 2)];
                                    i2 = inputBiomeIds[j1 + 1 + 1 + (i1 + 1) * (width + 2)];
                                    j2 = inputBiomeIds[j1 + 1 - 1 + (i1 + 1) * (width + 2)];
                                    k2 = inputBiomeIds[j1 + 1 + (i1 + 1 + 1) * (width + 2)];

                                    if (!isBiomeOceanic(l1) && !isBiomeOceanic(i2)
                                        && !isBiomeOceanic(j2)
                                        && !isBiomeOceanic(k2)) {
                                        outputBiomeIds[j1 + i1 * width] = landBiomeId;
                                    } else {
                                ...
                                if (!isBiomeOceanic(l1) && !isBiomeOceanic(i2)
                                    && !isBiomeOceanic(j2)
                                    && !isBiomeOceanic(k2)) {
                                    if (this.func_151633_d(l1) && this.func_151633_d(i2)
                                        && this.func_151633_d(j2)
                        ...
                        this.func_151632_a(
                            ...
                            width,
                            landBiomeId,
                            BiomeGenBase.stoneBeach.biomeID);
                    }
            }
        }
    ...
    private void func_151632_a(int[] inputBiomeIds, int[] outputBiomeIds, int x, int z, int width, int landBiomeId,
        int beachBiomeId) {
    ...
    private boolean func_151631_c(int p_151631_1_) {
        return BiomeGenBase.getBiome(p_151631_1_) != null && BiomeGenBase.getBiome(p_151631_1_)
            .getBiomeClass() == BiomeGenJungle.class
                ? true
                : p_151631_1_ == BiomeGenBase.jungleEdge.biomeID || p_151631_1_ == BiomeGenBase.jungle.biomeID
