...
public class WorldGenFieldAssociation {
    ...
    private static void associateFeatures() {
        associateFeature(
            "generateQuicksand",
            new WorldGenSplotches(BOPCBlocks.mud, 1, 24, Blocks.grass, Blocks.dirt, Blocks.sand));
        ...
        associateFeature(
            "generateStoneInGrass2",
            new WorldGenSplotches(Blocks.stone, 0, 48, Blocks.grass, Blocks.dirt));
        ...
        associateFeature(
            "generateAsh",
            new WorldGenSplotches(BOPCBlocks.ash, 0, 32, BOPCBlocks.ashStone, Blocks.netherrack));
        associateFeature("generateMycelium", new WorldGenSplotches(Blocks.mycelium, 0, 32, Blocks.grass));
        associateFeature(
            "generateSponge",
            new WorldGenSplotches(Blocks.sponge, 0, 24, Blocks.dirt, Blocks.sand, Blocks.gravel));
        ...
        associateFeature(
            "highCattailsPerChunk",
            new WorldGenBOPDoubleFlora(BOPCBlocks.plants, BOPCBlocks.plants, 10, 9));
        ...
        associateFeature(
            ...
            new WorldGenSplatter(BOPCBlocks.bopGrass, 1, BOPCBlocks.ash, Blocks.netherrack));
        ...
        associateFeature(
            "bopBigMushroomsPerChunk",
            new WorldGenBOPBigMushroom(Blocks.dirt, Blocks.grass, Blocks.mycelium, BOPCBlocks.overgrownNetherrack));
        ...
        associateFeature(
            "netherrackSplatterPerChunk",
            new WorldGenSplatter(Blocks.netherrack, BOPCBlocks.overgrownNetherrack));
    ...
    private static void associateFeaturesForced() {
        associateFeatureForced(
            "waterSpringsPerChunk",
            new WorldGenLiquids(Blocks.flowing_water),
            SpringForcedGenerator.class);
        associateFeatureForced(
            "lavaSpringsPerChunk",
    ...
    public static void associateFeatureForced(String name, WorldGenerator generator,
        Class<? extends ForcedWorldFeatureBOP> forcedFeature) {
    ...
    public static class WorldFeature {
        ...
        public IBOPWorldGenerator getBOPWorldGenerator() {
            if (this.worldGenerator instanceof IBOPWorldGenerator) {
                ...
                try {
                    return (IBOPWorldGenerator) forcedFeature.getConstructor(WorldGenerator.class)
                        .newInstance(worldGenerator);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
