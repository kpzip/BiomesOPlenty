...
public class ChunkProviderBOPHell implements IChunkProvider {
    ...
    public ChunkProviderBOPHell(World par1World, long par2) {
        ...
        /*
         * NoiseGeneratorOctaves[] noiseGens = {netherNoiseGen1, netherNoiseGen2, netherNoiseGen3,
    ...
    public void replaceBlocksForBiome(int par1, int par2, Block[] blocks, BiomeGenBase[] par4ArrayOfBiomeGenBase) {
        ...
        slowsandNoise = slowsandGravelNoiseGen
            .generateNoiseOctaves(slowsandNoise, par1 * 16, par2 * 16, 0, 16, 16, 1, d0, d0, 1.0D);
        gravelNoise = slowsandGravelNoiseGen
            .generateNoiseOctaves(gravelNoise, par1 * 16, 109, par2 * 16, 16, 1, 16, d0, 1.0D, d0);
        netherrackExclusivityNoise = netherrackExculsivityNoiseGen.generateNoiseOctaves(
    ...
    public Chunk provideChunk(int par1, int par2) {
        ...
        biomesForGeneration = worldObj.getWorldChunkManager()
            .loadBlockGeneratorData(biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
        ...
        BiomeGenBase[] abiomegenbase = worldObj.getWorldChunkManager()
    ...
    private double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6,
        ...
        double d0 = 684.412D;
        double d1 = 2053.236D;
        noiseData4 = netherNoiseGen6
            .generateNoiseOctaves(noiseData4, par2, par3, par4, par5, 1, par7, 1.0D, 0.0D, 1.0D);
        noiseData5 = netherNoiseGen7
            .generateNoiseOctaves(noiseData5, par2, par3, par4, par5, 1, par7, 100.0D, 0.0D, 100.0D);
        noiseData1 = netherNoiseGen3
            .generateNoiseOctaves(noiseData1, par2, par3, par4, par5, par6, par7, d0 / 80.0D, d1 / 60.0D, d0 / 80.0D);
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        MinecraftForge.EVENT_BUS
            .post(new PopulateChunkEvent.Pre(par1IChunkProvider, worldObj, hellRNG, par2, par3, false));
        ...
        MinecraftForge.EVENT_BUS
            .post(new PopulateChunkEvent.Post(par1IChunkProvider, worldObj, hellRNG, par2, par3, false));
