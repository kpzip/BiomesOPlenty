...
public class WorldGenBOPTaiga3 extends WorldGenAbstractTree {
    ...
    public WorldGenBOPTaiga3(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify,
                    ...
                    for (i4 = 0; i4 <= j1; ++i4) {
                        ...
                        for (int l2 = x - l3; l2 <= x + l3; ++l2) {
                            ...
                            for (int j3 = z - l3; j3 <= z + l3; ++j3) {
                                ...
                                if ((Math.abs(i3) != l3 || Math.abs(k3) != l3 || l3 <= 0) && world.getBlock(l2, k2, j3)
                                    .canBeReplacedByLeaves(world, l2, k2, j3)) {
