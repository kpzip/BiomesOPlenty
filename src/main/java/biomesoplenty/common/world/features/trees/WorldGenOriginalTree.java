...
public class WorldGenOriginalTree extends WorldGenAbstractTree {
    ...
    public WorldGenOriginalTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify,
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256) {
            ...
            if (!flag) {
                ...
                boolean isSoil = block2
                    .canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockSapling) Blocks.sapling);
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0) {
                                    ...
                                    if (block1.isAir(par1World, i2, k1, k2) || block1.isLeaves(par1World, i2, k1, k2)) {
                                        int metadata = this.isFruitTree ? (this.metaLeaves > 0
                                            ? (par2Random.nextInt(4) == 0 ? (this.metaLeaves - 1) : this.metaLeaves)
                                            : this.metaLeaves) : this.metaLeaves;
                        ...
                        for (k1 = par4 - 3 + l; k1 <= par4 + l; ++k1) {
                            ...
                            for (i2 = par3 - l1; i2 <= par3 + l1; ++i2) {
                                for (j2 = par5 - l1; j2 <= par5 + l1; ++j2) {
                                    if (par1World.getBlock(i2, k1, j2)
                                        .isLeaves(par1World, i2, k1, j2)) {
                                        if (par2Random.nextInt(4) == 0 && par1World.getBlock(i2 - 1, k1, j2)
                                            .isAir(par1World, i2 - 1, k1, j2)) {
                                        ...
                                        if (par2Random.nextInt(4) == 0 && par1World.getBlock(i2, k1, j2 - 1)
                                            .isAir(par1World, i2, k1, j2 - 1)) {
                            ...
                            for (k1 = 0; k1 < 2; ++k1) {
                                for (i3 = 0; i3 < 4; ++i3) {
                                    if (par2Random.nextInt(4 - k1) == 0) {
                                        ...
                                        this.setBlockAndNotifyAdequately(
                                            par1World,
                                            par3 + Direction.offsetX[Direction.rotateOpposite[i3]],
                                            par4 + l - 5 + k1,
                                            par5 + Direction.offsetZ[Direction.rotateOpposite[i3]],
                                            Blocks.cocoa,
                                            l1 << 2 | i3);
                                    }
                                }
