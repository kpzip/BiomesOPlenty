...
public class WorldGenGrassSplatter extends WorldGeneratorBOP {
    ...
    public boolean generate(World world, Random random, int x, int y, int z) {
        ...
        for (int var7 = 0; var7 < 128; ++var7) {
            ...
            // TODO: isAirBlock()
            if (world.isAirBlock(randX, randY, randZ) && (world.getBlock(randX, randY - 1, randZ) == BOPCBlocks.hardSand
                || world.getBlock(randX, randY - 1, randZ) == BOPCBlocks.mud
                || world.getBlock(randX, randY - 1, randZ) == BOPCBlocks.hardDirt
                || world.getBlock(randX, randY - 1, randZ) == Blocks.sand
                || world.getBlock(randX, randY - 1, randZ) == Blocks.stone)) {
