...
public class WorldGenSplotches extends WorldGeneratorBOP {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D) {
                            for (int var44 = var34; var44 <= var37; ++var44) {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D
                                    && world.getBlock(var38, var41, var44) != Blocks.air
                                    && (blockList.contains(world.getBlock(var38, var41, var44)))) {
    ...
    public void setupGeneration(World world, Random random, BOPBiome biome, String featureName, int x, int z) {
        if (featureName.equals("generateQuicksand")
            && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateQuicksand")) {
            for (int i = 0; i < 5; ++i) {
        ...
        } else if (featureName.equals("generateCanyon")
            && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateCanyon")) {
                for (int i = 0; i < 15; ++i) {
                    int randX = x + random.nextInt(16);
                    int randY = random.nextInt(64) + 64;
                    int randZ = z + random.nextInt(16);
            ...
            } else if (featureName.equals("generateStoneInGrass")
                && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateStoneInGrass")) {
                    for (int i = 0; i < 15; ++i) {
                        int randX = x + random.nextInt(16);
                        int randY = random.nextInt(64) + 64;
                        int randZ = z + random.nextInt(16);
                ...
                } else if (featureName.equals("generateStoneInGrass2")
                    && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateStoneInGrass2")) {
                        for (int i = 0; i < 20; ++i) {
                            int randX = x + random.nextInt(16);
                            int randY = random.nextInt(64) + 64;
                            int randZ = z + random.nextInt(16);
                    ...
                    } else if (featureName.equals("generateGrass")
                        && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateGrass")) {
                            for (int i = 0; i < 15; ++i) {
                                int randX = x + random.nextInt(16);
                        ...
                        } else if (featureName.equals("generateSand")
                            && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateSand")) {
                                for (int i = 0; i < 15; ++i) {
                                    int randX = x + random.nextInt(16);
                                    int randY = random.nextInt(128);
                                    int randZ = z + random.nextInt(16);
                            ...
                            } else if (featureName.equals("generateQuagmire")
                                && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateQuagmire")) {
                                    for (int i = 0; i < 15; ++i) {
                                        int randX = x + random.nextInt(16);
                                        int randY = random.nextInt(64) + 64;
                                        int randZ = z + random.nextInt(16);
                                ...
                                } else if (featureName.equals("generateAsh")
                                    && (Boolean) biome.theBiomeDecorator.bopFeatures.getFeature("generateAsh")) {
                                        for (int i = 0; i < 10; ++i) {
                                            int randX = x + random.nextInt(16);
                                            int randY = random.nextInt(128);
                                            int randZ = z + random.nextInt(16);
                                    ...
                                    } else if (featureName.equals("generateMycelium")
                                        && (Boolean) biome.theBiomeDecorator.bopFeatures
                                            .getFeature("generateMycelium")) {
                                                for (int i = 0; i < 10; ++i) {
                                                    int randX = x + random.nextInt(16);
                                                    int randY = random.nextInt(128);
                                                    int randZ = z + random.nextInt(16);
                                        ...
                                        if (featureName.equals("generateSponge")
                                            && (Boolean) biome.theBiomeDecorator.bopFeatures
                                                .getFeature("generateSponge")) {
                                                    for (int i = 0; i < 5; ++i) {
                                                        int randX = x + random.nextInt(16);
