...
public class WorldProviderSurfaceBOP extends WorldProviderSurface {
    ...
    public boolean canCoordinateBeSpawn(int x, int z) {
        ...
        boolean flag = topBlock == Blocks.sand || topBlock == Blocks.stone
            || topBlock == Blocks.snow_layer && this.worldChunkMgr.getBiomesToSpawnIn()
                .contains(this.worldObj.getBiomeGenForCoordsBody(x, z));
