...
public class BlockBOPFoliage extends BOPBlockWorldDecor implements IShearable {
    ...
    private static final String[] foliageTypes = new String[] { "duckweed", "shortgrass", "mediumgrass", "hedgebottom",
        "bush", "sprout", "hedgetop", "poisonivy", "berrybush", "shrub", "wheatgrass", "dampgrass", "koru",
        "cloverpatch", "leafpile", "deadleafpile" };
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune) {
        ...
        switch (meta) {
            ...
            case 5:
                if (world.rand.nextInt(50) != 0) return ret;
            ...
            case 12:
                if (world.rand.nextInt(32) != 0) return ret;
    ...
    public boolean isValidPosition(World world, int x, int y, int z, int metadata) {
        ...
        if (block == Blocks.air && world.provider.dimensionId != -1
    ...
    public int colorMultiplier(IBlockAccess world, int x, int y, int z) {
        if (world.getBlockMetadata(x, y, z) == 3 || world.getBlockMetadata(x, y, z) == 6
            || world.getBlockMetadata(x, y, z) == 9
            || world.getBlockMetadata(x, y, z) == 14) {
    ...
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitVecX,
