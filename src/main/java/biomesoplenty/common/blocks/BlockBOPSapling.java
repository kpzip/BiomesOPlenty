...
public class BlockBOPSapling extends BlockSapling {
    ...
    public boolean canBlockStay(World world, int x, int y, int z) {
        ...
        else return (world.getFullBlockLightValue(x, y, z) >= 8 || world.canBlockSeeTheSky(x, y, z)) && (soil != null
            && (soil.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, this) || soil == BOPCBlocks.bopGrass));
    }
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random) {
        ...
        if (obj == null) {
            switch (meta) {
                ...
                case 13: // Hellbark
                    obj = new WorldGenMiniShrub(
                        BOPCBlocks.logs4,
                        BOPCBlocks.leaves4,
                        1,
                        0,
                        BOPCBlocks.overgrownNetherrack);
                    break;
