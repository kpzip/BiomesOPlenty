        ...
        switch (side) {
            case 1:
                return (world.getBlock(x, y + 1, z)
                    .isWood(world, x, y + 1, z) || world.getBlock(x, y + 1, z) == Blocks.stone);
            case 2:
                return (world.getBlock(x, y, z + 1)
                    .isWood(world, x, y, z + 1) || world.getBlock(x, y, z + 1) == Blocks.stone);
            case 3:
                return (world.getBlock(x, y, z - 1)
                    .isWood(world, x, y, z - 1) || world.getBlock(x, y, z - 1) == Blocks.stone);
            case 4:
                return (world.getBlock(x + 1, y, z)
                    .isWood(world, x + 1, y, z) || world.getBlock(x + 1, y, z) == Blocks.stone);
            case 5:
                return (world.getBlock(x - 1, y, z)
                    .isWood(world, x - 1, y, z) || world.getBlock(x - 1, y, z) == Blocks.stone);
            default:
