...
public class BlockBOPSlab extends BlockSlab {
    ...
    public IIcon getIcon(int side, int meta) {
        if (category == SlabCategory.STONE) return textures[getRockType(meta)];
        else return textures[getWoodType(meta)];
    }
    ...
    public String func_150002_b(int meta) {
        if (category == SlabCategory.STONE) return (new StringBuilder()).append(rockTypes[getRockType(meta)])
            .append("Slab")
            .toString();
        else return (new StringBuilder()).append(woodTypes[getWoodType(meta)])
            .append("Slab")
            .toString();
    }
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        ...
        Block block = !field_150004_a ? this
            : (this == BOPCBlocks.woodenDoubleSlab1 ? BOPCBlocks.woodenSingleSlab1
                : (this == BOPCBlocks.woodenDoubleSlab2 ? BOPCBlocks.woodenSingleSlab2 : BOPCBlocks.stoneSingleSlab));
    ...
    private int getWoodType(int meta) {
        ...
        if (meta < woodTypes.length) return meta;
    ...
    private int getRockType(int meta) {
        ...
        if (meta < rockTypes.length) return meta;
