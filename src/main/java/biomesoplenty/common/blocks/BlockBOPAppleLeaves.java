...
public class BlockBOPAppleLeaves extends BlockLeavesBase implements IShearable {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        if (Loader.isModLoaded("BetterGrassAndLeavesMod")) for (int i = 0; i < 4; ++i) {
    ...
    public void updateTick(World world, int x, int y, int z, Random random) {
        ...
        if (random.nextInt(25) == 0) if (meta > 0) if ((meta & 3) < 3) {
            // TODO: setBlock()
    ...
    public void dropBlockAsItemWithChance(World world, int x, int y, int z, int metadata, float chance, int fortune) {
        ...
        // TODO: dropBlockAsItem_do
        else if ((metadata & 3) == 2 && world.rand.nextInt(16) == 0)
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.apple, 1, 0));
        // TODO: dropBlockAsItem_do
        else if ((metadata & 3) == 1 && world.rand.nextInt(48) == 0)
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.apple, 1, 0));
        // TODO: dropBlockAsItem_do
        else if ((metadata & 3) == 0 && world.rand.nextInt(80) == 0)
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.apple, 1, 0));
    }
