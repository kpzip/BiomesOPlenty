...
public class BlockBOPPlant extends BOPBlockWorldDecor implements IShearable {
    ...
    private static final String[] plants = new String[] { "deadgrass", "desertgrass", "desertsprouts", "dunegrass",
        "spectralfern", "thorn", "barley", "cattail", "rivercane", "cattailtop", "cattailbottom", "wildcarrot",
        "cactus", "witherwart", "reed", "root" };
    ...
    public boolean isValidPosition(World world, int x, int y, int z, int metadata) {
        ...
        switch (metadata) {
            ...
            case 7: // Cattail
                return block != Blocks.grass ? false
            ...
            case 15: // Root
                return root != Blocks.air && (root == Blocks.grass || root == Blocks.dirt
                    || root == Blocks.farmland
                    || root == BOPCBlocks.longGrass);
    ...
    public boolean canReplace(World world, int x, int y, int z, int side, ItemStack itemStack) {
        ...
        if (metadata == 5 || metadata == 13 || metadata == 15) return this.isValidPosition(world, x, y, z, metadata);
        else return (world.getFullBlockLightValue(x, y, z) >= 8 || world.canBlockSeeTheSky(x, y, z))
            && this.isValidPosition(world, x, y, z, metadata);
    }
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block neighborBlock) {
        ...
        if (world.getBlockMetadata(x, y, z) == CATTAILTOP && world.getBlock(x, y - 1, z) == this
            && world.getBlockMetadata(x, y - 1, z) != CATTAILBOTTOM) {
        ...
        if (meta == 5) {
            if (entity instanceof EntityPlayer) {
                ...
                if (!((inventory.armorInventory[0] != null
                    && inventory.armorInventory[0].getItem() == Items.leather_boots)
                    && (inventory.armorInventory[1] != null
                        && inventory.armorInventory[1].getItem() == Items.leather_leggings))) {
    ...
    public int quantityDropped(int meta, int fortune, Random random) {
        if (meta == 6) return random.nextInt(5) == 0 ? 1 : 0;
        else if (meta == 7 || meta == 8 || meta == 9) return 1;
        else if (meta == 11) return random.nextInt(7) == 0 ? 2 : 1;
        else if (meta == 13) return 1;
        else return 0;
    }
    ...
    public boolean isShearable(ItemStack item, IBlockAccess world, int x, int y, int z) {
        ...
        if (metadata == 7 || metadata == 8 || metadata == 9 || metadata == 11) return false;
        else return true;
    }
