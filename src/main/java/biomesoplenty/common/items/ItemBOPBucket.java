...
public class ItemBOPBucket extends ItemFluidContainer {
    ...
    public void getSubItems(Item item, CreativeTabs creativeTabs, List list) {
        ...
        this.fill(fluid, new FluidStack(BOPCFluids.poison, FluidContainerRegistry.BUCKET_VOLUME), true);
        list.add(fluid);
        fluid = new ItemStack(item);
        this.fill(fluid, new FluidStack(BOPCFluids.honey, FluidContainerRegistry.BUCKET_VOLUME), true);
        list.add(fluid);
    }
    ...
    public FluidStack drain(final ItemStack container, final int maxDrain, final boolean doDrain) {
        if (maxDrain < FluidContainerRegistry.BUCKET_VOLUME) return null;
