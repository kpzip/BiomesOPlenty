    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (movingobjectposition == null) {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
                ...
                /*
                 * TODO: FEATURE <Once Fluids Are Updated>if (par2World.getBlockId(i, j, k) ==
                 * Fluids.honey.get().blockID && par2World.getBlockMetadata(i, j, k) == 7)
                 * {
        ...
        if (par3EntityLivingBase instanceof EntityPixie) {
            ...
            if (par2EntityPlayer.inventory.getFirstEmptyStack() >= 0) {
                EntityItem entityitem = new EntityItem(
                    ...
                    new ItemStack(BOPCItems.jarFilled, 1, 2));
