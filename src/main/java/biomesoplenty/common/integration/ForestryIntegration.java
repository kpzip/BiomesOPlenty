...
public class ForestryIntegration {
    ...
    private static void addFermenterRecipes() {
        ...
        addFermenterRecipe(
            new ItemStack(BOPCBlocks.colorizedSaplings, 1, OreDictionary.WILDCARD_VALUE),
            250,
            LIQUID_BIOMASS);
    }
    ...
    private static void addSqueezerRecipes() {
        RecipeManagers.squeezerManager.addRecipe(
            10,
            new ItemStack[] { new ItemStack(BOPCItems.food) },
            FluidRegistry.getFluidStack(LIQUID_JUICE, 50),
            new ItemStack(mulch),
            5);
        RecipeManagers.squeezerManager.addRecipe(
            10,
            new ItemStack[] { new ItemStack(BOPCItems.food, 1, 8) },
            FluidRegistry.getFluidStack(LIQUID_JUICE, 200),
            new ItemStack(mulch),
            20);
    }
    ...
    private static void addBlocksToBackpack() {
        ...
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.colorizedSaplings, 1, OreDictionary.WILDCARD_VALUE));
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.saplings, 1, OreDictionary.WILDCARD_VALUE));
        ...
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.colorizedLeaves1, 1, OreDictionary.WILDCARD_VALUE));
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.colorizedLeaves2, 1, OreDictionary.WILDCARD_VALUE));
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.appleLeaves, 1, OreDictionary.WILDCARD_VALUE));
        BackpackManager.backpackItems[FORESTER]
            .add(new ItemStack(BOPCBlocks.persimmonLeaves, 1, OreDictionary.WILDCARD_VALUE));
    ...
    private static void addFermenterRecipe(ItemStack resource, int fermentationValue, String output) {
        RecipeManagers.fermenterManager.addRecipe(
            ...
            fermentationValue,
            1.0F,
            FluidRegistry.getFluidStack(output, 1),
            FluidRegistry.getFluidStack(LIQUID_WATER, 1));
        ...
        if (FluidRegistry.isFluidRegistered(LIQUID_JUICE)) {
            RecipeManagers.fermenterManager.addRecipe(
                ...
                1.5F,
                FluidRegistry.getFluidStack(output, 1),
                FluidRegistry.getFluidStack(LIQUID_JUICE, 1));
        }
        ...
        if (FluidRegistry.isFluidRegistered(LIQUID_HONEY)) {
            RecipeManagers.fermenterManager.addRecipe(
                ...
                1.5F,
                FluidRegistry.getFluidStack(output, 1),
                FluidRegistry.getFluidStack(LIQUID_HONEY, 1));
        }
    }
}
