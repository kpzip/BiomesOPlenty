...
public class ATGIntegration {
    ...
    private enum BiomeGroup {
        ...
        FOREST(BiomeType.LAND),
        JUNGLE(BiomeType.LAND),
        PLAINS(BiomeType.LAND),
        ICE_PLAINS(BiomeType.LAND),
        TAIGA(BiomeType.LAND),
        DESERT(BiomeType.LAND),
        SHRUBLAND(BiomeType.LAND),
        BOREAL_FOREST(BiomeType.LAND),
        TUNDRA(BiomeType.LAND),
        STEPPE(BiomeType.LAND),
        SAVANNA(BiomeType.LAND),
        TROPICAL_SHRUBLAND(BiomeType.LAND),
        WOODLAND(BiomeType.LAND),
        MESA(BiomeType.LAND),
        SWAMPLAND(BiomeType.LAND),
        OCEAN(BiomeType.SEA);
    ...
    private static void registerATGBiome(BiomeGroup group, BiomeGenBase biome, double weight) {
        if (BOPConfigurationBiomeGen.config.get("Overworld Biomes To Generate", biome.biomeName, true)
            .getBoolean(false)) {
