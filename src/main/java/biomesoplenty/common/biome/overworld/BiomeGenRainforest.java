...
public class BiomeGenRainforest extends BOPOverworldBiome {
    ...
    public WorldGenAbstractTree func_150567_a(Random random) {
        return random.nextInt(15) == 0 ? this.worldGeneratorTrees
            : (random.nextInt(5) == 0 ? worldGeneratorBigTree
                : new WorldGenOriginalTree(Blocks.log, Blocks.leaves, 0, 0, false, 8, 2, false));
    }
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return random.nextInt(4) == 0
            ? (random.nextInt(2) == 0 ? new WorldGenTallGrass(BOPCBlocks.foliage, 10)
                : new WorldGenTallGrass(BOPCBlocks.foliage, 11))
            : (random.nextInt(3) == 0 ? new WorldGenTallGrass(Blocks.tallgrass, 2)
