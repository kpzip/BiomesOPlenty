...
public class BiomeGenLavenderFields extends BOPOverworldBiome {
    ...
    public WorldGenAbstractTree func_150567_a(Random random) {
        return random.nextInt(3) == 0 ? this.worldGeneratorBigTree
            : new WorldGenOriginalTree(BOPCBlocks.logs4, BOPCBlocks.leaves4, 2, 1);
    }

    @Override
    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return random.nextInt(4) == 0 ? new WorldGenTallGrass(Blocks.tallgrass, 1)
            : new WorldGenTallGrass(BOPCBlocks.foliage, 10);
    }
