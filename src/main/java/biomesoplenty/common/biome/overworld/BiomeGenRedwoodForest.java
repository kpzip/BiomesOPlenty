...
public class BiomeGenRedwoodForest extends BOPOverworldBiome {
    ...
    public WorldGenAbstractTree func_150567_a(Random random) {
        return random.nextInt(2) == 0
            ? new WorldGenRedwoodTree2(BOPCBlocks.logs3, BOPCBlocks.colorizedLeaves1, 0, 3, false, 20, 15)
            : (random.nextInt(10) == 0 ? new WorldGenShrub(0, 0)
                : new WorldGenRedwoodTree(BOPCBlocks.logs3, BOPCBlocks.colorizedLeaves1, 0, 3, false, 40, 10));
    }
