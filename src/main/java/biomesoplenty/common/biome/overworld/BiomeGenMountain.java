...
public class BiomeGenMountain extends BOPOverworldBiome {
    ...
    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return random.nextInt(4) == 0 ? (random.nextInt(2) == 0 ? new WorldGenTallGrass(BOPCBlocks.foliage, 10)
            : new WorldGenTallGrass(BOPCBlocks.foliage, 11)) : new WorldGenTallGrass(Blocks.tallgrass, 1);
    }
