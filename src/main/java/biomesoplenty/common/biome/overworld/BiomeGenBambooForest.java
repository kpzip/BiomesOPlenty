...
public class BiomeGenBambooForest extends BOPOverworldBiome {
    ...
    @Override
    public void genTerrainBlocks(World world, Random random, Block[] p_150573_3_, byte[] p_150573_4_, int p_150573_5_,
    ...
    public WorldGenAbstractTree func_150567_a(Random random) {
        return random.nextInt(3) == 0 ? new WorldGenShrub(0, 0)
            : new WorldGenBulbTree(BOPCBlocks.bamboo, BOPCBlocks.leaves1, 0, 1, false, 10, 12, false);
    }

    @Override
    public WorldGenerator getRandomWorldGenForGrass(Random random) {
        return random.nextInt(4) == 0 ? new WorldGenTallGrass(Blocks.tallgrass, 2)
            : (random.nextInt(2) == 0 ? new WorldGenTallGrass(BOPCBlocks.foliage, 10)
                : (random.nextInt(2) == 0 ? new WorldGenTallGrass(BOPCBlocks.foliage, 11)
                    : (random.nextInt(8) == 0 ? new WorldGenBOPDoubleFlora(3)
                        : new WorldGenTallGrass(BOPCBlocks.foliage, 1))));
    }
