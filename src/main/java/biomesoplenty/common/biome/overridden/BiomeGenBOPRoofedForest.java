...
public class BiomeGenBOPRoofedForest extends BOPInheritedOverworldBiome {
    ...
    public BiomeGenBOPRoofedForest(int biomeID, BiomeGenBase inheritedBiome) {
        ...
        this.theBiomeDecorator.bopFeatures.weightedGrassGen
            .put(new WorldGenBOPTallGrass(BOPCBlocks.foliage, 10), 0.25D);
        this.theBiomeDecorator.bopFeatures.weightedGrassGen
            .put(new WorldGenBOPTallGrass(BOPCBlocks.foliage, 11), 0.25D);
    }

    @Override
    public WorldGenAbstractTree func_150567_a(Random random) {
        return (WorldGenAbstractTree) (random.nextInt(3) > 0 ? canopyTrees
            : (random.nextInt(5) != 0 ? this.worldGeneratorTrees : shortOakTrees));
    }
