        ...
        if (block == BOPCBlocks.saplings) {
            ...
            if (!world.isRemote) {
                if (world.rand.nextFloat() < 0.45D) {
                    // TODO: growTree()
                    ((BlockBOPColorizedSapling) BOPCBlocks.colorizedSaplings)
                        .func_149878_d(event.world, x, y, z, event.world.rand);
                }
            }
            ...
            for (int i1 = 0; i1 < 128; ++i1) {
                ...
                if (event.world.getBlock(x, var14, z)
                    .isAir(world, x, var14, z)) {
