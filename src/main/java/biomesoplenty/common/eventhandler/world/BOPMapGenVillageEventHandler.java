...
public class BOPMapGenVillageEventHandler extends MapGenVillage {
    ...
    public BOPMapGenVillageEventHandler() {
        ...
        ObfuscationReflectionHelper
            .setPrivateValue(MapGenVillage.class, this, BOPConfigurationVillages.villageDistance, "field_82665_g");
        ObfuscationReflectionHelper
            .setPrivateValue(MapGenVillage.class, this, BOPConfigurationVillages.villageDistance / 4, "field_82666_h");
    }
}
