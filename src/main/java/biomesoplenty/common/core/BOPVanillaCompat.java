...
public class BOPVanillaCompat {
    ...
    private static void addDungeonLoot() {
        ...
        if (BOPConfigurationMisc.dungeonLoot == true) {
            ...
            strongholdCorridor
                .addItem(new WeightedRandomChestContent(new ItemStack(BOPCBlocks.flowers, 1, 3), 1, 4, 25));
            strongholdCorridor
                .addItem(new WeightedRandomChestContent(new ItemStack(BOPCBlocks.flowers, 1, 2), 1, 4, 25));
            ...
            if (biome != null && biome instanceof BOPBiome) {
                ...
                if (biomeFeatures.weightedFlowerGen != null && !biomeFeatures.weightedFlowerGen.isEmpty()) {
                    ...
                    for (Entry<WorldGenerator, Integer> entry : flowerMap.entrySet()) {
                        if (entry.getKey() instanceof WorldGenBOPFlora
                            && !(entry.getKey() instanceof WorldGenBOPDoubleFlora)) {
