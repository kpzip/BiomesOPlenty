...
public class BOPBlocks {
    ...
    private static void registerBlocks() {
        ...
        stoneFormations = registerBlock(
            new BlockStoneFormations().setBlockName("stoneFormations"),
            ItemBlockStoneFormations.class);
        ...
        persimmonLeaves = registerBlock(
            new BlockBOPPersimmonLeaves().setBlockName("persimmonLeaves"),
            ItemBlockPersimmonLeaves.class);
        ...
        colorizedSaplings = registerBlock(
            new BlockBOPColorizedSapling().setBlockName("colorizedSaplings"),
            ItemBlockColorizedSapling.class);
        ...
        biomeBlock = registerBlock(
            new BlockBOPGeneric(Material.glass, BlockType.BIOME_BLOCK).setBlockName("biomeBlock"));
        ...
        BlockBOPSlab singleSlab = (BlockBOPSlab) new BlockBOPSlab(false, Material.wood, SlabCategory.WOOD1)
            .setBlockName("woodenSingleSlab1");
        BlockBOPSlab doubleSlab = (BlockBOPSlab) new BlockBOPSlab(true, Material.wood, SlabCategory.WOOD1)
            .setBlockName("woodenDoubleSlab1");
        ...
        singleSlab = (BlockBOPSlab) new BlockBOPSlab(false, Material.wood, SlabCategory.WOOD2)
            .setBlockName("woodenSingleSlab2");
        doubleSlab = (BlockBOPSlab) new BlockBOPSlab(true, Material.wood, SlabCategory.WOOD2)
            .setBlockName("woodenDoubleSlab2");
        ...
        singleSlab = (BlockBOPSlab) new BlockBOPSlab(false, Material.rock, SlabCategory.STONE)
            .setBlockName("stoneSingleSlab");
        doubleSlab = (BlockBOPSlab) new BlockBOPSlab(true, Material.rock, SlabCategory.STONE)
            .setBlockName("stoneDoubleSlab");
        ...
        sacredoakStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.SACREDOAK).setBlockName("sacredoakStairs"));
        cherryStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.CHERRY).setBlockName("cherryStairs"));
        ...
        mangroveStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.MANGROVE).setBlockName("mangroveStairs"));
        palmStairs = registerBlock(new BlockBOPStairs(BOPCBlocks.planks, Category.PALM).setBlockName("palmStairs"));
        redwoodStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.REDWOOD).setBlockName("redwoodStairs"));
        willowStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.WILLOW).setBlockName("willowStairs"));
        pineStairs = registerBlock(new BlockBOPStairs(BOPCBlocks.planks, Category.PINE).setBlockName("pineStairs"));
        hellBarkStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.HELL_BARK).setBlockName("hellBarkStairs"));
        jacarandaStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.JACARANDA).setBlockName("jacarandaStairs"));
        mahoganyStairs = registerBlock(
            new BlockBOPStairs(BOPCBlocks.planks, Category.MAHOGANY).setBlockName("mahoganyStairs"));

        mudBricksStairs = registerBlock(
            new BlockBOPStairs(mudBricks, Category.MUD_BRICKS).setBlockName("mudBricksStairs"));

        colorizedLeaves1 = registerBlock(
            new BlockBOPColorizedLeaves(ColourizedLeafCategory.CAT1).setBlockName("colorizedLeaves1"),
            ItemBlockColorizedLeaves.class);
        colorizedLeaves2 = registerBlock(
            new BlockBOPColorizedLeaves(ColourizedLeafCategory.CAT2).setBlockName("colorizedLeaves2"),
            ItemBlockColorizedLeaves.class);
