...
public interface IPostalCarrier {
     ...
     * @param letterstack ItemStack representing the letter. See {@link IPostRegistry} for helper functions to validate
     *                    and extract it.
     * @param doDeliver   Whether or not the letter is supposed to actually be delivered or if delivery is only to be
     *                    simulated.
     * @return {link IPostalState} holding information on success or failure for delivery.
     */
    IPostalState deliverLetter(World world, IPostOffice office, String recipient, ItemStack letterstack,
        boolean doDeliver);
