...
/**
 * Manages {@link ISpeciesRoot}, {@link IAllele}s, {@link IFruitFamily}s, {@link IClassification}, the blacklist and
 * allows creation of research notes.
 *
 * @author SirSengir
 */
public interface IAlleleRegistry {
     ...
     * @param uid
     *                   String based unique identifier. Implementation will throw an exception if the key is already
     *                   taken.
     * @param scientific
