...
public interface IFarmListener {
     ...
     * 
     * @param harvested
     *                  Collection of harvested stacks. May be manipulated. Ensure removal of stacks with 0 or less
     *                  items!
     * @param crop
    ...
    /**
     * Called after the stack of collected items has been returned by the farm logic, but before it is added to the
     * farm's pending queue.
     * 
     * @param collected
     *                  Collection of collected stacks. May be manipulated. Ensure removal of stacks with 0 or less
     *                  items!
     * @param logic
     */
    ...
    /**
     * Called after the stack of harvested crops has been returned by the farm logic, but before it is added to the
     * farm's pending queue.
     * 
     * @param harvested
     * @param logic
     ...
     * @param extent
     */
    void hasScheduledHarvest(Collection<ICrop> harvested, IFarmLogic logic, int x, int y, int z,
        ForgeDirection direction, int extent);
