...
public interface ICarpenterManager extends ICraftingProvider {
     ...
     * 
     * @param box
     *                  ItemStack of one item representing the required box (carton, crate) for this recipe. May be
     *                  null.
     * @param product
     *                  Crafting result.
     * @param materials
     *                  Materials needed in the crafting matrix. This gets passed directly to {@link ShapedRecipes}.
