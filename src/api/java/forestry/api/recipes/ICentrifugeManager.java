 ...
 * 
 * The manager is initialized at the beginning of Forestry's BaseMod.load() cycle. Begin adding recipes in
 * BaseMod.ModsLoaded() and this shouldn't be null even
...
public interface ICentrifugeManager extends ICraftingProvider {
     ...
     * @param products
     *                    HashMap<ItemStack, Integer> specifying the possible products and the chances of them resulting
     *                    from centrifugation.
     */
     ...
     * @param chances
     *                    Array of integers corresponding and matching to produce providing the chance (0-100) for the
     *                    ItemStack at the given index to be
     *                    produced.
     */
