...
public interface ITileStructure {
    ...
    /**
     * @return String unique to the type of structure controlled by this structure logic. Should map to
     *         {@link IStructureLogic}
     */
    String getTypeUID();
    ...
    /**
     * Called to set the master TileEntity. Implementing TileEntity should keep track of the master's coordinates, not
     * refer to the TE object itself.
     * 
     * @param tile
     */
