...
/**
 * Optional annotation to provide additional information on IPlugins. This information will be available via the
 * "/forestry plugin info $pluginID" command ingame.
 * 
 * @author SirSengir
 */
