...
public enum EnumTemperature {
    ...
    /**
     * Determines if a given BiomeGenBase is of HELLISH temperature, since it is treated seperatly from actual
     * temperature values.
    ...
    /**
     * Determines if a given biomeID is of HELLISH temperature, since it is treated seperatly from actual temperature
     * values.
     * Uses the BiomeDictionary.
     * 
    ...
    public static boolean isBiomeHellish(int biomeID) {
        return BiomeDictionary.isBiomeRegistered(biomeID)
            && BiomeDictionary.isBiomeOfType(BiomeGenBase.getBiome(biomeID), BiomeDictionary.Type.NETHER);
    }
