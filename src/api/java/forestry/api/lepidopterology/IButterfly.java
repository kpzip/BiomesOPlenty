...
public interface IButterfly extends IIndividualLiving {
     ...
     * @param y
     * @param z
     * @return true if the butterfly can naturally spawn at the given location at this time. (Used to auto-spawn
     *         butterflies from tree leaves.)
     */
     ...
     * @param y
     * @param z
     * @return true if the butterfly can take flight at the given location at this time. (Used to auto-spawn butterflies
     *         from dropped items.)
     */
